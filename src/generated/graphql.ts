...
export type GetStopsByRadiusQuery = {
  __typename?: 'QueryType'
  stopsByRadius?: {
    __typename?: 'stopAtDistanceConnection'
    edges?: Array<{
 ...
 * });
 */
export function useGetStopsQuery(
  baseOptions?: Apollo.QueryHookOptions<GetStopsQuery, GetStopsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetStopsQuery, GetStopsQueryVariables>(
    GetStopsDocument,
    options
  )
}
export function useGetStopsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetStopsQuery,
    GetStopsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetStopsQuery, GetStopsQueryVariables>(
    GetStopsDocument,
    options
  )
}
export type GetStopsQueryHookResult = ReturnType<typeof useGetStopsQuery>
export type GetStopsLazyQueryHookResult = ReturnType<
  typeof useGetStopsLazyQuery
>
export type GetStopsQueryResult = Apollo.QueryResult<
  GetStopsQuery,
  GetStopsQueryVariables
>
 ...
 * });
 */
export function useGetStopByIdQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetStopByIdQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetStopByIdQuery, GetStopByIdQueryVariables>(
    GetStopByIdDocument,
    options
  )
}
export function useGetStopByIdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetStopByIdQuery,
    GetStopByIdQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetStopByIdQuery, GetStopByIdQueryVariables>(
    GetStopByIdDocument,
    options
  )
}
export type GetStopByIdQueryHookResult = ReturnType<typeof useGetStopByIdQuery>
export type GetStopByIdLazyQueryHookResult = ReturnType<
  typeof useGetStopByIdLazyQuery
>
export type GetStopByIdQueryResult = Apollo.QueryResult<
  GetStopByIdQuery,
  GetStopByIdQueryVariables
>
export const GetStopsByRadiusDocument = gql`
...
/**
 * __useGetStopsByRadiusQuery__
 *
 * To run a query within a React component, call `useGetStopsByRadiusQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetStopsByRadiusQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetStopsByRadiusQuery({
 *   variables: {
 *      lat: // value for 'lat'
 *      lon: // value for 'lon'
 ...
 * });
 */
export function useGetStopsByRadiusQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetStopsByRadiusQuery,
    GetStopsByRadiusQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetStopsByRadiusQuery, GetStopsByRadiusQueryVariables>(
    GetStopsByRadiusDocument,
    options
  )
}
export function useGetStopsByRadiusLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetStopsByRadiusQuery,
    GetStopsByRadiusQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetStopsByRadiusQuery,
    GetStopsByRadiusQueryVariables
  >(GetStopsByRadiusDocument, options)
}
export type GetStopsByRadiusQueryHookResult = ReturnType<
  typeof useGetStopsByRadiusQuery
>
export type GetStopsByRadiusLazyQueryHookResult = ReturnType<
  typeof useGetStopsByRadiusLazyQuery
>
export type GetStopsByRadiusQueryResult = Apollo.QueryResult<
  GetStopsByRadiusQuery,
  GetStopsByRadiusQueryVariables
>
