...
export type GetStationsQuery = { __typename?: 'QueryType', stations?: Array<{ __typename?: 'Stop', name: string, stops?: Array<{ __typename?: 'Stop', gtfsId: string, name: string, code?: string | null, platformCode?: string | null } | null> | null } | null> | null };
 ...
 * });
 */
export function useGetStopsByRadiusQuery(baseOptions: Apollo.QueryHookOptions<GetStopsByRadiusQuery, GetStopsByRadiusQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetStopsByRadiusQuery, GetStopsByRadiusQueryVariables>(GetStopsByRadiusDocument, options);
      }
export function useGetStopsByRadiusLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetStopsByRadiusQuery, GetStopsByRadiusQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetStopsByRadiusQuery, GetStopsByRadiusQueryVariables>(GetStopsByRadiusDocument, options);
        }
export type GetStopsByRadiusQueryHookResult = ReturnType<typeof useGetStopsByRadiusQuery>;
export type GetStopsByRadiusLazyQueryHookResult = ReturnType<typeof useGetStopsByRadiusLazyQuery>;
export type GetStopsByRadiusQueryResult = Apollo.QueryResult<GetStopsByRadiusQuery, GetStopsByRadiusQueryVariables>;